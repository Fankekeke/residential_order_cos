            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-select v-model="queryParams.repairType" allowClear>
                  <a-select-option value="排水系统">排水系统</a-select-option>
                  <a-select-option value="照明系统">照明系统</a-select-option>
                  <a-select-option value="燃气系统">燃气系统</a-select-option>
                  <a-select-option value="道路设施">道路设施</a-select-option>
                  <a-select-option value="安防系统">安防系统</a-select-option>
                  <a-select-option value="绿化设施">绿化设施</a-select-option>
                  <a-select-option value="环保设施">环保设施</a-select-option>
