<template>
  <a-modal v-model="show" title="用户信息" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px" v-if="ownerData !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;" :gutter="15">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">用户房屋</span></a-col>
