          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.deviceCharge"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
...
import unitAdd from './DeviceAdd.vue'
import unitEdit from './DeviceEdit.vue'
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case '0':
              return <a-tag color="red">废弃</a-tag>
            case '1':
              return <a-tag>正常</a-tag>
            case '2':
              return <a-tag>维修保养中</a-tag>
            default:
              return '- -'
          }
        }
