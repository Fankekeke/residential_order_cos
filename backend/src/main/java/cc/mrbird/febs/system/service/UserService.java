...
public interface UserService extends IService<User> {
     ...
     * @param username       用户名
     * @param password       密码
     * @param ownerInfo 账户名称
     */
    void registEnterprise(String username, String password, OwnerInfo ownerInfo) throws Exception;
     ...
     */
    void registStaff(String username, String password, WorkerInfo staffInfo) throws Exception;
