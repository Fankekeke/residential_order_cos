...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Autowired
    private IOwnerInfoService userInfoService;
    @Autowired
    private IWorkerInfoService staffInfoService;
     ...
     */
    @Override
    public void registEnterprise(String username, String password, OwnerInfo enterpriseInfo) throws Exception {
        ...
        userInfoService.save(enterpriseInfo);
     ...
     */
    @Override
    public void registStaff(String username, String password, WorkerInfo staffInfo) throws Exception {
